...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-start pt-20 px-6 overflow-hidden bg-obsidian border-b border-iron/20">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 select-none overflow-hidden opacity-200">
        <img 
          src={mountainBg} 
      ...
      >
        ...
        <motion.h1
          variants={itemVariants}
          className="text-6xl sm:text-8xl md:text-[9.5rem] font-bold tracking-tighter leading-[0.85] text-pure-white max-w-5xl uppercase font-suisse select-none"
